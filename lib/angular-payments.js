...
.factory('_Format', ['Cards', 'Common', '$filter',
    function(Cards, Common, $filter) {
...
.factory('_Validate', ['Cards', 'Common', '$parse',
    function(Cards, Common, $parse) {
...
.factory('_ValidateWatch', ['_Validate',
    function(_Validate) {
